========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ShootingGame
========================================================================


AppWizard が生成した ShootingGame には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ShootingGame を構成している各ファイルの概要説明が含まれています。
...
ShootingGame.h
    ...
    みます） をインクルードし、また CShootingGameApp アプリケーションクラスを宣
    言します。

ShootingGame.cpp
    このファイルは CShootingGameApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ShootingGame.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル ShootingGame.rc によってインクルード
    されます。

res\ShootingGame.rc2
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、ShootingGame.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////

AppWizard は 1 つのドキュメントタイプと 1 つのビューを作成します。

ShootingGameDoc.h, ShootingGameDoc.cpp - ドキュメント
    これらのファイルは CShootingGameDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CShootingGameDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

ShootingGameView.h, ShootingGameView.cpp - ビュー
    これらのファイルは CShootingGameView クラスを含みます。
    CShootingGameView オブジェクトは CShootingGameDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ShootingGame.pch 
