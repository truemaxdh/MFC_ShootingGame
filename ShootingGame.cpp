// ShootingGame.cpp : アプリケーション用クラスの機能定義を行います。
//
...
/////////////////////////////////////////////////////////////////////////////
// 唯一の CShootingGameApp オブジェクト

CShootingGameApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CShootingGameApp クラスの初期化
...
BOOL CShootingGameApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CShootingGameDoc),
		RUNTIME_CLASS(CMainFrame),       // メイン SDI フレーム ウィンドウ
		RUNTIME_CLASS(CShootingGameView));
